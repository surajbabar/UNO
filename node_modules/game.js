...
game.declareUno = function (plyr) {
    ...
    log.push(getTime() + " " + plyr.name + " has declared uno\n");
}
...
game.catchUno = function (caughtPlayerIndex, smartPlayer) {
    ...
    if (player.checkUno(caughtPlayer)) {
        ...
        player.takeCard(caughtPlayer, draw());
        log.push(getTime() + " " + caughtPlayer.name + " caught by " + smartPlayer.name + "\n");
    }
    else
...
game.moveForwardAsPlayerTookNoActionOnDrawnCard = function (plyr) {
    log.push(getTime() + " no action played by " + plyr.name + " after draw a card\n");
    nextTurn();
}
...
var updateLogAfterDrawTwo = function (plyr) {
    log.push(getTime() + " " + plyr.name + " drew " + drawTwoRun * 2 + " " + " cards" + "\n");
}
...
var updateLogAfterPlay = function (plyr, playedCard) {
    ...
    log.push(getTime() + " " + plyr.name + " played a " +cardDetail+ " \n");
}
